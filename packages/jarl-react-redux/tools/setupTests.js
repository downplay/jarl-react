...
// KNOWN ISSUE (ticket 51): there is no Enzyme adapter for React 19 — see
// packages/jarl-react/tools/setupTests.js for details. Tests using
// `shallow`/`mount` in this package are expected to fail until they're
// ported off Enzyme.
try {
