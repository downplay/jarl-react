...
describe("<RoutingProvider/>", () => {
    ...
    let two: boolean;
    let marker: symbol;
    let resolveOneSignal: any;
    let resolveTwoSignal: any;
    ...
    beforeEach(() => {
        ...
        routes = new RouteMap([
            ...
            },
            {
                ...
                state: {},
                match: ({ someState }: any, { callback }: any) => {
                    callback(someState);
                    return { someState };
                }
            },
    ...
    describe("constructor", () => {
        test("errors with no routes", () => {
            expect(() => {
                shallow(<RoutingProvider {...({} as any)} />);
            }).toThrow(/Invalid routes property/);
        });

        test("errors with no history", () => {
            expect(() => {
                shallow(<RoutingProvider {...({ routes: [] } as any)} />);
    ...
    describe("initial navigation", () => {
        ...
        test("don't add extra slash when just changing query", () => {
            ...
            expect((rendered[0] as any).attribs.href).toEqual("/foo?foo=bar");
        });
