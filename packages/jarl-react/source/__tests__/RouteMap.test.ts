    ...
    describe("query strings", () => {
        ...
        describe("misc", () => {
            test("periods in query can be matched", () => {
                ...
                const { location } = routes.match(path as string);
        ...
        beforeEach(() => {
            routes = new RouteMap([
                ...
                },
                {
                    ...
                    stringify: (location: any) =>
                        location.usersList ? location : false,
                    routes: [
                        {
                            path: "/ban?users=:usersList",
                            state: { action: "ban" },
                            stringify: ({ users, ...rest }: any) => ({
