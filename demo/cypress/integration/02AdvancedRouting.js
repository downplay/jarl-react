...
describe("Advanced Routing", () => {
    it("loads home page", () => {
        ...
        cy.get("[data-test-demo-link=advancedRouting]").should(
            "have.attr",
            "data-test-active",
            "true",
        );
    ...
    it("defaults to details tab on product page", () => {
        ...
        cy.get("[data-test=details-tab]").should("exist").and("contain", "Details");
    ...
    it("navigates to other tabs on product page", () => {
        ...
        cy.get("[data-test=ratings-tab]").should("exist").and("contain", "Ratings");
        ...
        cy.get("[data-test=gallery-tab]").should("exist").and("contain", "Gallery");
        cy.get("[data-test=image-full-size]")
            .should("exist")
    ...
    it("navigates to different pictures in the gallery", () => {
        ...
        for (let n = 2; n <= 10; n++) {
            ...
            cy.get("[data-test=image-full-size]")
                .should("exist")
                .and("have.attr", "src", `https://picsum.photos/200/300?image=${n - 1}`);
        }
    });

    it("has missing image id for missing image", () => {
        cy.visit(`${root}/product/gallery/11`);
        cy.get("[data-test=missing-image]")
            .should("exist")
